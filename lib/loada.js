(function() {
  ...
  this.Loada = (function() {
    ...
    Loada.prototype.key = function() {
      return "" + this.prefix + "." + this.set;
    };
    ...
    Loada.prototype.require = function(libraries) {
    ...
    Loada.prototype.load = function(callback) {
      ...
      progress = new this.Progress(this.requires.length, callback.progress);
      loaders = 0;
      return this._ensureSizes(callback.progress != null, function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          _results.push(_this._loadGroup(group.slice(0), progress, function() {
            ...
            if (loaders === 0) {
              _this.save();
              return typeof callback.success === "function" ? callback.success() : void 0;
            }
          }));
        }
        return _results;
    ...
    Loada.prototype._loadGroup = function(group, progress, callback) {
      ...
      if (this.options.localStorage && this.storage[library.key]) {
        if (progress != null) {
